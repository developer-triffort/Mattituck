...
public class SearchMovieActivity extends Activity implements android.widget.CompoundButton.OnCheckedChangeListener
{
	boolean resume=true;
	EditText searchText;
	ToggleButton tButton;
	String urlPart1="http://alpha2.suffolk.lib.ny.us/search/Y?SEARCH=(";
	String urlPart2=")&SORT=D&m=d&m=g&searchscope=";
	String url="";
	int width;
	int flag=78;
	@Override
	protected void onCreate(Bundle savedInstanceState) {
		...
		searchText=(EditText)findViewById(R.id.ser_mov_edit_search);
		tButton=(ToggleButton)findViewById(R.id.ser_mov_toggleButton1);
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.activity_search_movie, menu);
		return true;
	}
	@Override
